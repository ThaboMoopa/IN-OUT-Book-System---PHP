...
{ 
	...
	else
	{
		...
		else
		{
			...
			{
				echo '<p class="text--error" style="font-size: 1em;">We do not have that much stock in Books. Try again.'; 
			}
			else
...
if($showForm == TRUE)
{
		...
		echo '<h4 class="text--primary">Latest books to swap</h4>';
				$Books->getSwapBooks();  
